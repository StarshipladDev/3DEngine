...
namespace DoomCloneV2
{
    ...
    public class Unit:Entity
    {
        ...
        public void setUpUnit(int x, int y, Globals.UnitType enemyType, bool friendly)
        {
            this.x = x;
            this.y = y;
        ...
        public void CreateProjectile(int targetX, int targetY)
        {
            ...
            switch (unitType)
            {
                case Globals.UnitType.Devil:
                    ...
                    Debug.WriteLine("-------------");
                    this.projs.Add(new Projectile("Resources/Images/Projectiles/Fireball/Flame.png",100,this));
                ...
                case Globals.UnitType.SoldierGun:
                    ...
                    Debug.WriteLine("Proj's count of firing Unit is " + projs.Count());
                    Debug.WriteLine("-------------");
                    this.projs.Add(new Projectile("Resources/Images/Projectiles/Target/Target.png",400,this));
                    Debug.WriteLine("-------------");
                    Debug.WriteLine("Proj's count of firing Unit is " + projs.Count() + " after creating, setting values , xand y of unit is" + this.x + "," + this.y);
                    Debug.WriteLine("-------------");
